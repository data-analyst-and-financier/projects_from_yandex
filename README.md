...
| 2 | Анализ рынка общепита | Исследование заведений общественного питания Москвы, выработка рекомендаций по открытию нового объекта общепита| `pandas`, `matplotlib.pyplot`,  `plotly.express`, `seaborn`, `numpy`, `json`, `folium`,  `folium.plugins`|
